...
const PRONOUNCE = [
  /* פְּרָט ל... = חוץ מ. בלי ניקוד נשמע כמו מילה אחרת לגמרי.
     המילה "פרטי" לא נפגעת — גבול המילה חוסם. */
  ['פרט', 'פְּרָט'],
  /* שֶׁלֶט = תמרור/שילוט. בלי ניקוד המנוע קורא את זה כפועל.
     כל צורה צריכה שורה משלה, כי גבול המילה בודק תו עברי —
     ולכן "שלט" לא נתפס בתוך "השלט". */
  ['שלט',    'שֶׁלֶט'],
  ['השלט',   'הַשֶּׁלֶט'],
  ['בשלט',   'בַּשֶּׁלֶט'],
  ['ושלט',   'וְשֶׁלֶט'],
